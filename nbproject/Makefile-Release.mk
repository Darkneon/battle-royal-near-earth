...
${OBJECTDIR}/source/Logic/Bullet.o: source/Logic/Bullet.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Logic/Bullet.o source/Logic/Bullet.cpp
...
${OBJECTDIR}/source/Model/MissileModel.o: source/Model/MissileModel.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Model/MissileModel.o source/Model/MissileModel.cpp
...
${OBJECTDIR}/source/Logic/PlayerUFO.o: source/Logic/PlayerUFO.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Logic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Logic/PlayerUFO.o source/Logic/PlayerUFO.cpp
...
${OBJECTDIR}/source/Model/Robot/BulletModel.o: source/Model/Robot/BulletModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Model/Robot
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Model/Robot/BulletModel.o source/Model/Robot/BulletModel.cpp
...
${OBJECTDIR}/source/Model/Static/StaticModel.o: source/Model/Static/StaticModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Model/Static
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Model/Static/StaticModel.o source/Model/Static/StaticModel.cpp
...
${OBJECTDIR}/source/Helper/SoundHelper.o: source/Helper/SoundHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Helper
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Helper/SoundHelper.o source/Helper/SoundHelper.cpp
...
${OBJECTDIR}/source/Logic/AIPlayer.o: source/Logic/AIPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Logic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Logic/AIPlayer.o source/Logic/AIPlayer.cpp

${OBJECTDIR}/source/Logic/JoystickInput.o: source/Logic/JoystickInput.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Logic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Logic/JoystickInput.o source/Logic/JoystickInput.cpp
...
${OBJECTDIR}/source/Logic/BulletManager.o: source/Logic/BulletManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Logic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Logic/BulletManager.o source/Logic/BulletManager.cpp
...
${OBJECTDIR}/source/Model/Helper/BoundingBox.o: source/Model/Helper/BoundingBox.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/Model/Helper
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/source/Model/Helper/BoundingBox.o source/Model/Helper/BoundingBox.cpp
