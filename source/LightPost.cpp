...
GLfloat LightPost::setPosX(GLfloat x)
{
    posX = x;
}
GLfloat LightPost::setPosY(GLfloat Y)
{
    posY = Y;
}
GLfloat LightPost::setPosZ(GLfloat z)
{
    posZ = z;
}
GLfloat LightPost::updatePosition(GLfloat x, GLfloat y, GLfloat z)
{
    posX = x;
    posY = y;
    posZ = z;
